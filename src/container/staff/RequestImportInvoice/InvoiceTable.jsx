...
const InvoiceTable = ({ invoices, handleViewDetails, handleDelete }) => {
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {invoices.map((invoice) => (
                        <tr key={invoice.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">{invoice.invoiceStatus === "DRAFT" ? "Chờ duyệt" : invoice.invoiceStatus === "CONFIRMED" ? "Đã duyệt" : "Từ chối"}</td>
                                    ...
                                    >
                                        ...
                                        {invoice.invoiceStatus === "DRAFT" && (
                                            <>
                                                <MenuItem
                                                    onClick={() => {
                                                        handleMenuAction(invoice, "DELETE");
                                                    }}
                                                >
                                                   Xóa
                                                </MenuItem>
